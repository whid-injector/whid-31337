...
void printMenu(void) {
  ...
  //###LBOtest
  //Keyboard Unit Test
  Serial.println(F("[K] Inject Keystrokes"));
  Serial.println(F("[k] Test Mousejack Feature [NOT WORKING NOW]"));  //### TO ADD Mousejack Test
  //###LBOtest
  Serial.println(F("-------------------------------------"));
...
void loop() {
  ...
  //###LBOTest
	case 'K': {
        ...
        Keyboard.press(KEY_LEFT_GUI);
        delay(50);
        Keyboard.press((char) 114); //In Decimal
   ...
   case 'k': {
        Serial.println(F("Not Working Now! [WIP]"));
//        reset();
//        scan();
//        fingerprint();
//        launch_attack();
