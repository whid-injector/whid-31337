...
#define CE 5//5 for F32u4   | Put 9 for Pro Micro 3.3v version (can work also with 5 though)
#define CSN 6//6 for F32u4   | Put 8 for Pro Micro 3.3v version (can work also with 6 though)
#define PKT_SIZE 37
#define PAY_SIZE 32
#define MICROSOFT 1
#define LOGITECH 2
